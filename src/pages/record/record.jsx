  ...
  render() {
    return (
      <main className="common-con-top">
        <PublicHeader title='Record' />
        <section className="record-nav-con">
          <nav className="record-nav">
            <NavLink to={`${this.props.match.path}/passed`} className="nav-link">Confirmed</NavLink>
            <NavLink to={`${this.props.match.path}/audited`} className="nav-link">Pending</NavLink>
            <NavLink to={`${this.props.match.path}/failed`} className="nav-link">Failed</NavLink>
          </nav>
