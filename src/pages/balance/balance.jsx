    ...
    return (
      <main className="home-container">
        ...
        <section className="broke-main-content">
          <p className="broke-header">Total balance $ {this.state.balance.balance}</p>
          <form className="broke-form">
            <p>Please enter the amount you want to withdraw（USD）</p>
            <p>$ <input type="text" value={this.state.applyNum} placeholder="0.00" onInput={this.handleInput} maxLength="5" /></p>
          </form>
          <TouchableOpacity className="submit-btn" clickCallBack={this.sumitForm} text="Withdraw request" />
        </section>
